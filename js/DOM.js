...
function moveRight() {
    ...
    var newPositionR = currentPositionR[0] + 3.1 - initialX;
    // check if collision
    player.style.transform = `translate(${newPositionR}px, ${currentPositionR[1]}px)`;
    console.log(getPosition());
};

function moveLeft() {
    var currentPositionL = getPosition();
    var newPositionL = currentPositionL[0] - 3.1 - initialX;
    //check if collision
    player.style.transform = `translate(${newPositionL}px, ${currentPositionL[1]}px)`;
...
function jump() {
    ...
    var newPositionJ = currentPositionJ[1] - 40 - initialY;
    player.style.transform = `translate(${currenPositionJ[0]}px, ${newPositionJ}px)`;
